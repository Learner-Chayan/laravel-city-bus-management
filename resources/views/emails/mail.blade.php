    ...
    <div class="wrapper" style="background-color: rgb(242, 242, 242); height: auto; min-height: 100%;"><table style="border-collapse: collapse; table-layout: fixed; color: #b8b8b8; font-family: Ubuntu,sans-serif;" align="center">
        <tbody>
        <tr>
            ...
            <td class="column" style="padding: 0px; text-align: left; vertical-align: top; color: rgb(96, 102, 109); line-height: 21px; font-family: sans-serif; width: 600px;">
                ...
                <div style="font-size: 14px; margin-left: 20px; margin-right: 20px;">
                    ...
                    <p>
                        ...
                        @if($image)<img width = "450" src="{{asset('public/images/slider/')}}/{{$image}}" alt="">@endif
                    </p>
                </div>
                <div style="font-size: 14px; margin-left: 20px; margin-right: 20px;"><br></div>
                <div style="margin-left: 20px; margin-right: 20px; margin-bottom: 24px;">
                    <p class="size-14" style="margin-top: 0px; margin-bottom: 0px; line-height: 21px;"><font size="3"><b>THANK YOU FOR COMING</b></font><br> <strong style="font-size: 14px;"></strong></p>
{{--                    <p class="size-14" style="margin-top: 0px; margin-bottom: 0px; line-height: 21px;"><font size="3"><b>THANK YOU FOR COMING</b></font><br> <strong style="font-size: 14px;">{{$basic->title}}</strong></p>--}}
                </div>
            </td>
        </tr>
        </tbody>
