    ...
    <div class="card ui-tab-card">
        <div class="card-body">
            ...
            @foreach($media as $cat)
                ...
                <a href="{{route('file-download',$cat->file_name)}}" class="btn-fill-sm text-light bg-dark-high"><img style="height: 96px; width: 96px;" src="{{asset("public/images/media/$cat->file_name")}}" alt=""></a>&nbsp;&nbsp;&nbsp;
                ...
                <div class="modal-body">
                    <form method="POST" enctype="multipart/form-data" id="uploadFile">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="media_category_id" value="{{$category->id}}">
